...
# A graphical user interface for clustering and clustering validation. methods 
# Supports Kmeans, Hierarchical, Spectral Clustering and various internal and external indices. The internal indices include: 
