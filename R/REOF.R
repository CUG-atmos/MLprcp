...
#' 
#' https://github.com/CUG-atmos/wql/blob/master/R/eof.R
#' @keywords ts
#' @examples
...
#' eof(chla1, 1)
REOF <- function (x, n, center = FALSE, scale. = FALSE, retx = TRUE){
  ...
  pr1 <- prcomp(x, center = center, scale. = scale., retx = retx)
